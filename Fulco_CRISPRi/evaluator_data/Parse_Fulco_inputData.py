...
eg_pairs = pd.read_csv("/scratch/st-cdeboer-1/iluthra/game_apis/RestAPI/Fulco_CRISPRi/evaluator_data/Supplementary Table 3a. Data for E-G pairs.csv", sep = ";", engine = "python")
print(eg_pairs)
